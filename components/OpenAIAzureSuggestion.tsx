...
async function OpenAIAzureSuggestion({ term }: { term: string }) {
  ...
  //       {
  //         role: "system",
  //         content: `you are a digital video assitant working for services such as Netflix, Disney Plus & Amazon Prime
  //           Video. Your job is to provide suggestions based on the videos the user specifies. Provide an quirky breakdown
